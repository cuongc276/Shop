                 	...
                 	<tr>
	                     ...
	                     <td>
	                         <a
	                             ...
	                             href="${ pageContext.request.contextPath }/admin/product/edit?id=${ item.id }">Update</a>
	                     </td>
	                     <td>
							  ...
							  <div class="modal-dialog">
							    <div class="modal-content">
							      ...
							      <div class="modal-footer">
							        ...
							        <a type="button" class="btn btn-primary" href="${ pageContext.request.contextPath }/admin/product/soft_delete?id=${ item.id }">Xóa mềm</a>
							      </div>
							    </div>
							  </div>
							</div>
